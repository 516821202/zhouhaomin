<template>
	<div>
			...
			<div class="foods-wrapper" ref="foodsWrapper">
				<ul>
					<li v-for="(item,key) in goods" class="food-list food-list-hook" :key="key">
						...
						<ul>
							<li @click="selectFood(food,$event)" v-for="(food,index) in item.foods" class="food-item border-bottom-1px" :key="index">
								<div class="icon">
      ...
      <shop ref="shopcart" :select-foods="selectFoods"  :delivery-price="seller.deliveryPrice" :min-price="seller.minPrice"></shop>
